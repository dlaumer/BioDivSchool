...
define([
    ...
    return class Content {
        ...
        init() {
            ...
            page_regionalitaet.addElement("dropdownInput", "a9_arten", {text:"Wie viele verschiedene Arten von Wildpflanzen wachsen auf der gesamten Untersuchungsfläche?", placeholder: "Auswählen", options: [{key: "0", label: "weniger als 10 verschiedene Arten"}, {key: "1", label: "11 – 20 Arten"}, {key: "2", label: "21 – 35 Arten"}, {key: "4", label: "36 – 50 Arten"}, {key: "4", label: "mehr als 50 verschiedene Arten"}]})
